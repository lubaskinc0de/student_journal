...
class Ui_EditLesson(object):
    def setupUi(self, EditLesson):
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.note_edit)
        self.mark_spinbox = QtWidgets.QSpinBox(parent=self.horizontalWidget)
        self.mark_spinbox.setObjectName("mark_spinbox")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.mark_spinbox)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.ItemRole.FieldRole, self.room_spinbox)
        self.index_number_spinbox = QtWidgets.QSpinBox(parent=self.horizontalWidget)
        self.index_number_spinbox.setObjectName("index_number_spinbox")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.ItemRole.FieldRole, self.index_number_spinbox)
        ...
        self.submit_btn = QtWidgets.QPushButton(parent=self.horizontalWidget)
        self.submit_btn.setObjectName("submit_btn")
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.ItemRole.LabelRole, self.submit_btn)
        self.delete_btn = QtWidgets.QPushButton(parent=self.horizontalWidget)
        self.delete_btn.setObjectName("delete_btn")
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.ItemRole.FieldRole, self.delete_btn)
