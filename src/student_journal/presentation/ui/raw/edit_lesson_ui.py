...
class Ui_EditLesson(object):
    def setupUi(self, EditLesson):
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.ItemRole.FieldRole, self.index_number_spinbox)
        ...
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.ItemRole.FieldRole, self.delete_btn)
